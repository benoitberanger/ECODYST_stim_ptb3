...
TEXT.size_Instruction = round(S.TaskParam.NBack.Text.SizeInstruction * S.PTB.Video.Y_total_px)              ; % FontSize
TEXT.size_Stim        = round(S.TaskParam.NBack.Text.SizeStim        * S.PTB.Video.Y_total_px)                     ; % FontSize

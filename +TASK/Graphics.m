...
p.Tetris3D.FieldOfView   = 25;            % degre
p.Tetris3D.LIGHT0_pos    = [100 100 100]; % [X Y Z] OpenGL coordinates
p.Tetris3D.LIGHT0_is_pt  = 0;             % 0 == infinit distance (direction) // 1 == finit distance (point)
